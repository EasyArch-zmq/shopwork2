/*! jQuery v3.5.1 | (c) JS Foundation and other contributors | jquery.org/license */ ! function (e, t) {
    ...
    var d = function (n) {
        ...
        }, d.sortStable = S.split("").sort(D).join("") === S, d.detectDuplicates = !!l, T(), d.sortDetached =
            ce(function (e) {
    ...
    S.event = {
        ...
        void 0 === e.defaultPrevented && !1 === e.returnValue ? Ce : Ee, this.target = e.target && 3 ===
        ...
        which: function (e) {
            var t = e.button;
            return null == e.which && be.test(e.type) ? null != e.charCode ? e.charCode : e.keyCode : !
    ...
    function Be(e, t, n) {
        ...
        Me.test(a) && Fe.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth =
        ...
        l.style && (l.style.backgroundClip = "content-box", l.cloneNode(!0).style.backgroundClip = "", y.clearCloneStyle =
            ...
            reliableTrDimensions: function () {
                ...
                return null == a && (e = E.createElement("table"), t = E.createElement("tr"), n = E
                    ...
                    t.style.height = "1px", n.style.height = "9px", re.appendChild(e).appendChild(
                    t).appendChild(n), r = C.getComputedStyle(t), a = 3 < parseInt(r.height),
                    re.removeChild(e)), a
            }
        }))
    }();
    ...
    S.extend({
        ...
        S.cssHooks[u] = {
            get: function (e, t, n) {
                if (t) return !Ve.test(S.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect()
            ...
            set: function (e, t, n) {
                ...
                return a && o && (s -= Math.ceil(e["offset" + u[0].toUpperCase() + u.slice(1)] -
                    parseFloat(i[u]) - Ke(e, u, "border", !1, i) - .5)), s && (r = te.exec(t)) &&
                "px" !== (r[3] || "px") && (e.style[u] = t, t = S.css(e, u)), Je(0, t, s)
            }
        }
        ...
        _default: {
            ...
            set: function (e) {
                ...
                null == e.elem.style[Xe(e.prop)] ? e.elem[e.prop] = e.now : S.style(e.elem, e.prop,
                    e.now + e.unit)
            }
        }
    ...
    S.Animation = S.extend(ft, {
        ...
        .type = "checkbox", y.checkOn = "" !== rt.value, y.optSelected = it.selected, (rt = E.createElement("input"))
    ...
    S.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return "undefined" == typeof e.getAttribute ? S.prop(e,
                ...
                .match.bool.test(t) ? pt : void 0)), void 0 !== n ? null === n ? void S.removeAttr(
        ...
        trigger: function (e, t, n, r) {
            ...
            (e.target = n), t = null == t ? [e] : S.makeArray(t, [e]), c = S.event.special[d] ||
                ...
                return e.type = d, r || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(
                    ...
                    S.event.triggered = d, e.isPropagationStopped() && f.addEventListener(d, wt), n[
                    d](), e.isPropagationStopped() && f.removeEventListener(d, wt), S.event.triggered =
    ...
    Wt.href = Tt.href, S.extend({
        ...
        ajax: function (e, t) {
            ...
            if (x.promise(T), v.url = ((e || v.url || Tt.href) + "").replace(Pt, Tt.protocol + "//"), v
                ...
                r = E.createElement("a");
                try {
                    r.href = v.url, r.href = r.href, v.crossDomain = Wt.protocol + "//" + Wt.host != r.protocol +
                        "//" + r.host
                } catch (e) {
                    v.crossDomain = !0
                }
            ...
            for (i in (g = S.event && v.global) && 0 == S.active++ && S.event.trigger("ajaxStart"), v.type =
                v.type.toUpperCase(), v.hasContent = !Ot.test(v.type), f = v.url.replace(qt, ""), v.hasContent ?
                ...
                "application/x-www-form-urlencoded") && (v.data = v.data.replace(jt, "+")) : (o = v
                    ...
                    (Et.test(f) ? "&" : "?") + v.data, delete v.data), !1 === v.cache && (f = f.replace(
                    Lt, "$1"), o = (Et.test(f) ? "&" : "?") + "_=" + Ct.guid++ + o), v.url = f + o),
            v.ifModified && (S.lastModified[f] && T.setRequestHeader("If-Modified-Since", S.lastModified[
                ...
                T.setRequestHeader("Accept", v.dataTypes[0] && v.accepts[v.dataTypes[0]] ? v.accepts[v.dataTypes[
                    0]] + ("*" !== v.dataTypes[0] ? ", " + It + "; q=0.01" : "") : v.accepts["*"]), v.headers
                ...
                o = function (e) {
                    return function () {
                        o && (o = a = r.onload = r.onerror = r.onabort = r.ontimeout = r.onreadystatechange =
                            ...
                            t(_t[r.status] || r.status, r.statusText, "text" !== (r.responseType ||
    ...
    S.ajaxSetup({
        ...
        if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = m(e.jsonpCallback) ? e.jsonpCallback() :
            e.jsonpCallback, a ? e[a] = e[a].replace(Vt, "$1" + r) : !1 !== e.jsonp && (e.url += (Et.test(
