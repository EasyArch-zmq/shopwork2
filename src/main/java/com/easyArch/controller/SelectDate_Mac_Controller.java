...
@RestController
public class SelectDate_Mac_Controller {
    ...
    @ResponseBody
    @RequestMapping(value = "/selectDataNumberBox_id"
    ...
    public String selectDateNumber(@RequestBody DateAndAddress dateAndAddress) {
        ...
        if (dateAndAddress != null) {
            ...
            String mac_address=dateAndAddress.getMac_address();
            DateNumberAll dateNumberAll=new DateNumberAll();
            if(mac_address!=null){
                dateNumberAll.setMac_address(mac_address);
            }else {
